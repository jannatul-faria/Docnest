                ...
                <aside class="w-full lg:w-72 space-y-8">
                    ...
                    <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100">
                        <div class="bg-primary px-5 py-3 flex items-center gap-3">
                            ...
                            <p class="text-sm font-black text-white uppercase tracking-wider">Divisions</h4>
                        </div>
                        <div class="py-2">
                            <button onclick="setDivision('')"
                                ...
                                data-id="">
                                <div class="h-2 w-2 rounded-full bg-primary text-white"></div>
                                All Divisions
                            </button>
                            @foreach($divisions as $div)
                    ...
                    <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100">
                        <div class="bg-primary px-5 py-3 flex items-center gap-3">
                            ...
                            <p class="text-sm font-black text-white uppercase tracking-wider">Doctor's Category</h4>
                        </div>
                        <div class="py-2">
                    ...
                    <button onclick="resetFilters()"
                        class="w-full py-3 bg-slate-100 text-slate-600 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-primary transition-all flex items-center justify-center gap-2">
            ...
            function updateActiveStates(filters) {
                document.querySelectorAll('.division-btn').forEach(btn => {
                    if (btn.getAttribute('data-id') == filters.division_id) {
                        ...
                        btn.querySelector('.rounded-full')?.classList.replace('bg-primary', 'bg-primary');
                        ...
                        if (btn.getAttribute('data-id') === '') {
                            btn.querySelector('.rounded-full')?.classList.add('bg-primary');
                        }
                    }
                });
