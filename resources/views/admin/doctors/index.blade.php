                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <form id="delete-form-{{ $doctor->id }}" action="{{ route('admin.doctors.destroy', $doctor) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" onclick="confirmDelete('delete-form-{{ $doctor->id }}', 'Are you sure? This will delete the doctor profile and the user account permanently.')" class="p-2 text-rose-600 hover:bg-rose-50 rounded-lg transition-colors" title="Delete">
