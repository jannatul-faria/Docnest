<x-admin-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <x-card>
            <x-slot name="header">Department Information</x-slot>
            ...
            <form action="{{ route('admin.departments.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" 
                              class="w-full rounded-xl border-slate-200 focus:border-blue-500 focus:ring-blue-500 transition-all duration-200"
                              placeholder="Describe this department...">{{ old('description') }}</textarea>
                ...
                <div class="flex items-center justify-end space-x-3 pt-4">
                    ...
                    <x-button variant="primary">Create Department</x-button>
                </div>
            </form>
        </x-card>
    </div>
