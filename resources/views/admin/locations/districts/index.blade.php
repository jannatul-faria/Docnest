                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <form id="delete-form-{{ $district->id }}" action="{{ route('admin.districts.destroy', $district) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" onclick="confirmDelete('delete-form-{{ $district->id }}', 'Are you sure you want to delete this district? This action will also remove all associated areas.')" class="p-2 text-rose-600 hover:bg-rose-50 rounded-lg transition-colors" title="Delete">
