    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50/50">
                <h3 class="text-lg font-medium text-slate-900">Add New Area</h3>
                <p class="text-sm text-slate-500">Enter the details for the new location area.</p>
            </div>

            <form action="{{ route('admin.areas.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="district_id" id="district_id" class="w-full rounded-lg border-slate-200 focus:border-blue-500 focus:ring-blue-500 transition-colors @error('district_id') border-rose-500 @enderror" disabled>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g. Dhanmondi" class="w-full rounded-lg border-slate-200 focus:border-blue-500 focus:ring-blue-500 transition-colors @error('name') border-rose-500 @enderror">
                    @error('name')
                        <p class="mt-1 text-sm text-rose-500">{{ $message }}</p>
                    @enderror
                </div>
