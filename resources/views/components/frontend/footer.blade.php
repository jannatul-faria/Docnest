            ...
            <div class="col-span-1">
                <a href="{{ route('home') }}" class="flex items-center mb-6">
                    @if(get_setting('logo_white'))
                        <img src="{{ asset('storage/' . get_setting('logo_white')) }}"
                            alt="{{ get_setting('site_name', 'DocNest') }}" class="h-14 w-auto object-contain">
                ...
                <div class="flex space-x-4">
                    @if(get_setting('social_facebook'))
                        <a href="{{ get_setting('social_facebook') }}" target="_blank"
                    ...
                    @if(get_setting('social_twitter'))
                        <a href="{{ get_setting('social_twitter') }}" target="_blank"
                            class="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-[#1c8251] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                    ...
                    @if(get_setting('social_linkedin'))
                        <a href="{{ get_setting('social_linkedin') }}" target="_blank"
                            class="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-[#1c8251] transition-all">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
